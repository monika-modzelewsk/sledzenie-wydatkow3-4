...
def show_expenses(month):  #wydatki miesięczne
...
while True:
    ...
    #zmiany: sprawdzamy czy w menu uzytkownik podal liczbe - walidacja, czy podal z odpowiedniego przedzialu (1-12)
    #rozbudować statystyki, od najwikeszych do najwiekszych
    #wyświtlanie wydatków jednego typu